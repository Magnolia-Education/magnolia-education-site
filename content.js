  ...
  "homepage": {
    ...
    "values": {
      ...
      "items": [
        ...
        {
          "icon": "✨",
          "title": "The Beauty of Learning",
          "body": "We believe every subject has an elegance to it. We help students discover the joy of a clean proof, a compelling argument, a well-placed comma."
        }
      ]
    },
    "testimonials": {
      ...
      "items": [
        {
          ...
          "body": "Tutoring that teaches students how to learn effectively and take control of their education."
        },
        {
          "icon": "images/computer.png",
          "iconAlt": "Computer",
          "title": "Flexibility for the real world",
          "body": "Reschedule sessions around tests and extracurricular activities—no hassle!"
        },
        {
          "icon": "images/a plus.png",
          "iconAlt": "A+",
          "title": "Self-awareness & confidence",
          "body": "Students are equipped to identify where they need help most for more focused sessions."
        },
        {
          "icon": "images/speech bubbles.png",
          "iconAlt": "Speech bubbles",
          "title": "Professional support",
          "body": "Engaging, empathetic, and qualified tutors that foster deep, meaningful connections."
        },
        {
          "icon": "images/beauty.png",
          "iconAlt": "Flower",
          "title": "Stress management",
          "body": "Students learn regulation and stress management tools that carry them beyond the classroom."
        }
      ]
    },
    "howItWorks": {
  ...
  "studySkills": {
    ...
    "homework": {
      ...
      "steps": [
        {
          "number": "01",
          "title": "Attempt without notes",
          "body": "Try every question before looking at notes or the textbook. The struggle is where learning happens."
        },
        {
          "number": "02",
          "title": "Mark your own work",
          "body": "Use the solutions to mark each question yourself. Don’t just check — understand why you got it wrong."
        },
        {
          "number": "03",
          "title": "Write what went wrong",
          "body": "One sentence for every mistake. This is the most underrated step in all of studying."
        },
        {
          "number": "04",
          "title": "Redo every mistake",
          "body": "Redo every question you got wrong. Not tomorrow — right now. This is how marks improve."
        }
      ]
    },
    "cta": {
      ...
      "steps": [
        {
          "number": "01",
          "title": "Lesson",
          "body": "Concepts taught live on Bitpaper — interactive, visual, and designed to stick."
        },
        {
          "number": "02",
          "title": "Beautiful study notes",
          "body": "Professionally designed notes summarising the lesson, theirs to keep and use all semester."
        },
        {
          "number": "03",
          "title": "Homework",
          "body": "Minimal and focused on the lesson content — quality over quantity."
        },
        {
          "number": "04",
          "title": "Self-mark",
          "body": "Full solutions provided so students mark their own work independently and understand every step."
        }
      ]
    },
    "cta": {
